          ...
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <label className={labelClassName}>
              ...
              <input
                ...
                onChange={(e) => updateField("communicationSkill", e.target.value)}
                required
              />
            </label>
            <label className={labelClassName}>
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <label className={labelClassName}>
              ...
              <input
                ...
                onChange={(e) => updateField("numberOfActivities", e.target.value)}
                required
              />
            </label>
            <label className={labelClassName}>
            ...
            <label className={labelClassName}>
              ...
              <select
                ...
                onChange={(e) => updateField("internshipExperience", e.target.value)}
                required
              >
                <option value="">Select</option>
                <option value="Yes">Yes</option>
            ...
            <label className={labelClassName}>
              ...
              <select
                ...
                onChange={(e) => updateField("networkingOrReferral", e.target.value)}
                required
              >
                <option value="">Select</option>
                <option value="Yes">Yes</option>
            ...
            <label className={`${labelClassName} sm:col-span-2`}>
              ...
              <select
                ...
                onChange={(e) => updateField("jobAlignsWithEducation", e.target.value)}
                required
              >
                <option value="">Select</option>
                <option value="Yes">Yes</option>
